...
public class Tienda {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (opcion == 1) {
                System.out.print("¿Cuántas camisetas desea comprar? ");
                cantidadCamisetas = cantidadCamisetas + sc.nextInt();
            } else if (opcion == 2) {
                System.out.print("¿Cuántos pantalones desea comprar? ");
        ...
        System.out.println("El sub total de las camisetas es de: $" + (int)subtotalCamisetas);
        System.out.println("Iva de las camisetas: $" + (int)ivaCamisetas);
        System.out.println("Descuento total de las camisetas: $" + (int)descuentoCamisetas);
        System.out.println("Total camisetas: $" + (int)totalCamisetas);

        System.out.println("El sub total de los pantalones es de: $" + (int)subtotalPantalones);
        System.out.println("Iva de los pantalones: $" + (int)ivaPantalones);
        System.out.println("Descuento total de los pantalones: $" + (int)descuentoPantalones);
        System.out.println("Total pantalones: $" + (int)totalPantalones);

        System.out.println("El sub total de las chaquetas es de: $" + (int)subtotalChaquetas);
        System.out.println("Iva de las chaquetas: $" + (int)ivaChaquetas);
        System.out.println("Descuento total de las chaquetas: $" + (int)descuentoChaquetas);
